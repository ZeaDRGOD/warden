...
const coupons = ["WARDEN-PROMO-10", 10];
...
document.getElementById('productcart').addEventListener('submit', function(event) {
    ...
    const webhookURL = 'https://discord.com/api/webhooks/1374727639813722214/lfDAmUFU9ibWCSnhprqog9rjWtdwRSMS0ff-Yb0J6NrdjF-I0f-wf1o8ImCjmaKhsflF';
